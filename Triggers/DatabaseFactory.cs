...
namespace ConfigureOneFlag
{
    ...
    class DatabaseFactory
    {
        ...
        {
            SQLCommand = "Insert Into GR_CfgItem (order_num,order_line_num,seq,smartpart_num,item_num,description,cost,price,sell_price,weight,uom,priority_level) values (" + (char)39 + item.CO_Num + (char)39 + "," + (char)39 + item.CO_Line + (char)39 + "," + (char)39 + item.Sequence + (char)39 + "," + (char)39 + item.Smartpart.Substring(0, C1Dictionaries.DBFieldLenCfgItem("CfgItem:smartpart_num", ref item)) + (char)39 + "," + (char)39 + item.Item.Substring(0, C1Dictionaries.DBFieldLenCfgItem("CfgItem:item_num", ref item)) + (char)39 + "," + (char)39 + item.Desc.Substring(0, C1Dictionaries.DBFieldLenCfgItem("CfgItem:description", ref item)) + (char)39 + "," + (char)39 + item.ItemCost + (char)39 + "," + (char)39 + item.ItemPrice + (char)39 + "," + (char)39 + item.ItemSellPrice + (char)39 + "," + (char)39 + item.ItemWeight + (char)39 + "," + (char)39 + item.UnitOfMeasure.Substring(0, C1Dictionaries.DBFieldLenCfgItem("CfgItem:uom", ref item)) + (char)39 + "," + (char)39 + item.PriorityLevel + (char)39 + ")";
            using (SqlConnection myConnection = new SqlConnection(connectionString))
            {
                SqlCommand myCommand = new SqlCommand(SQLCommand, myConnection);
                myConnection.Open();
        ...
        public static void WriteRecordCfg(ref zCfgParmVal cfg)
        {
            ...
            SQLCommand = "Insert Into GR_CfgParmVal (order_num,order_line_num,name,value,type,label,priority_level) values (" + (char)39 + cfg.CO_Num + (char)39 + "," + (char)39 + cfg.CO_Line + (char)39 + "," + (char)39 + cfName.Substring(0, C1Dictionaries.DBFieldLenParmVal("CfgParmVal:name", ref cfg)) + (char)39 + "," + (char)39 + cfValue.Substring(0, C1Dictionaries.DBFieldLenParmVal("CfgParmVal:value", ref cfg)) + (char)39 + "," + (char)39 + cfg.CType.Substring(0, C1Dictionaries.DBFieldLenParmVal("CfgParmVal:type", ref cfg)) + (char)39 + "," + (char)39 + cfLabel.Substring(0, C1Dictionaries.DBFieldLenParmVal("CfgParmVal:label", ref cfg)) + (char)39 + "," + (char)39 + cfg.PriorityLevel + (char)39 + ")";
            using (SqlConnection myConnection = new SqlConnection(connectionString))
            {
                SqlCommand myCommand = new SqlCommand(SQLCommand, myConnection);
                myConnection.Open();
        ...
        {
            SQLCommand = "Insert Into GR_CfgCOItem (order_num,order_line_num,ser_num,item_num,smartpart_num,description,unit_price,unit_cost,discount_amt,quantity,priority_level,due_date,config_type) values (" + (char)39 + coitem.CO_Num + (char)39 + "," + (char)39 + coitem.CO_Line + (char)39 + "," + (char)39 + coitem.Serial.Substring(0, C1Dictionaries.DBFieldLenCOItem("COItem:ser_num", ref coitem)) + (char)39 + "," + (char)39 + coitem.Item.Substring(0, C1Dictionaries.DBFieldLenCOItem("COItem:item_num", ref coitem)) + (char)39 + "," + (char)39 + coitem.Smartpart.Substring(0, C1Dictionaries.DBFieldLenCOItem("COItem:smartpart_num", ref coitem)) + (char)39 + "," + (char)39 + coitem.Desc.Substring(0, C1Dictionaries.DBFieldLenCOItem("COItem:description", ref coitem)) + (char)39 + "," + (char)39 + coitem.UnitPrice + (char)39 + "," + (char)39 + coitem.UnitCost + (char)39 + "," + (char)39 + coitem.Discount + (char)39 + "," + (char)39 + coitem.QTY + (char)39 + "," + (char)39 + coitem.PriorityLevel + (char)39 + "," + (char)39 + coitem.DueDate + (char)39 + "," + (char)39 + coitem.ConfigType + (char)39 + ")";
            using (SqlConnection myConnection = new SqlConnection(connectionString))
            {
                SqlCommand myCommand = new SqlCommand(SQLCommand, myConnection);
                myConnection.Open();
        ...
        {
            SQLCommand = "Insert Into GR_CfgCO (id,order_num,order_ref_num,cust_name,cust_ref_num,account_num,erp_reference_num,project,payment_terms,ship_via,shipping_terms,bill_to_contact_name,bill_address_line_1,bill_address_line_2,bill_address_line_3,bill_to_city,bill_to_state,bill_to_country,bill_to_postal_code,bill_to_phone_number,bill_to_fax_number,bill_to_email_address,bill_to_ref_num,ship_to_contact_name,ship_address_line_1,ship_address_line_2,ship_address_line_3,ship_to_city,ship_to_state,ship_to_country,ship_to_postal_code,ship_to_phone_number,ship_to_fax_number,ship_to_email_address,ship_to_ref_num,priority_level,due_date) values (" + (char)39 + co.Identifier + (char)39 + "," + (char)39 + co.CO_Num + (char)39 + "," + (char)39 + co.CORefNum + (char)39 + "," + (char)39 + co.CustName + (char)39 + "," + (char)39 + co.CustRefNum + (char)39 + "," + (char)39 + co.AccountNum + (char)39 + "," + (char)39 + co.ErpReferenceNum + (char)39 + "," + (char)39 + co.Project + (char)39 + "," + (char)39 + co.PaymentTerms + (char)39 + "," + (char)39 + co.ShipVia.Substring(0, C1Dictionaries.DBFieldLenCO("CO:ship_via", ref co)) + (char)39 + "," + (char)39 + co.ShippingTerms.Substring(0, C1Dictionaries.DBFieldLenCO("CO:shipping_terms", ref co)) + (char)39 + "," + (char)39 + co.BillToContactName + (char)39 + "," + (char)39 + co.BillToAddressLine1 + (char)39 + "," + (char)39 + co.BillToAddressLine2 + (char)39 + "," + (char)39 + co.BillToAddressLine3 + (char)39 + "," + (char)39 + co.BillToCity + (char)39 + "," + (char)39 + co.BillToState + (char)39 + "," + (char)39 + co.BillToCountry + (char)39 + "," + (char)39 + co.BillToPostalCode + (char)39 + "," + (char)39 + co.BillToPhoneNumber.Substring(0, C1Dictionaries.DBFieldLenCO("CO:bill_to_phone_number", ref co)) + (char)39 + "," + (char)39 + co.BillToFaxNumber.Substring(0, C1Dictionaries.DBFieldLenCO("CO:bill_to_fax_number", ref co)) + (char)39 + "," + (char)39 + co.BillToEmailAddress + (char)39 + "," + (char)39 + co.BillToRefNum + (char)39 + "," + (char)39 + co.ShipToContactName + (char)39 + "," + (char)39 + co.ShipToAddressLine1 + (char)39 + "," + (char)39 + co.ShipToAddressLine2 + (char)39 + "," + (char)39 + co.ShipToAddressLine3 + (char)39 + "," + (char)39 + co.ShipToCity + (char)39 + "," + (char)39 + co.ShipToState + (char)39 + "," + (char)39 + co.ShipToCountry + (char)39 + "," + (char)39 + co.ShipToPostalCode + (char)39 + "," + (char)39 + co.ShipToPhoneNumber + (char)39 + "," + (char)39 + co.ShipToFaxNumber + (char)39 + "," + (char)39 + co.ShipToEmailAddress + (char)39 + "," + (char)39 + co.ShipToRefNum + (char)39 + "," + (char)39 + co.PriorityLevel + (char)39 + "," + (char)39 + co.DueDate + (char)39 + ")";
            using (SqlConnection myConnection = new SqlConnection(connectionString))
            {
                SqlCommand myCommand = new SqlCommand(SQLCommand, myConnection);
                myConnection.Open();
