...
namespace ConfigureOneFlag
{
    ...
    class DatabaseFactory
    {
        ...
        public static string RetrieveSLCO (string orderNum)
        {
            ...
            SQLCommand = "Select TOP 1 co_num as SLCO From CO c Where c.est_num = " + (char)39 + orderNum + (char)39 + " Order By c.order_date desc, c.co_num desc";
            using (SqlConnection myConnection = new SqlConnection(connectionString))
            {
                SqlCommand myCommand = new SqlCommand(SQLCommand, myConnection);
                myConnection.Open();
